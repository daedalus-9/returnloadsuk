  ...
  return (
    <section className="relative border-b border-zinc-800">
      <MaxWidthWrapper className="relative z-20 flex flex-col items-center justify-center pb-16 pt-28 text-center md:pb-36 md:pt-36">
        ...
        >
          <GlowingChip>Serving Hauliers Across Wales</GlowingChip>
        </motion.div>
        ...
        >
          Logic Freight connects shippers and subcontractors across Wales — from
          Cardiff to Wrexham. Whether you’re moving pallets, containers, or
          general haulage, we match you with vetted partners ready to move.
        </motion.p>
